...
public class JobController {
    ...
    public String add(Model model, @Valid JobForm jobForm, Errors errors) {
        ...
        CoreCompetency aCoreCompentency = jobData.getCoreCompetencies().findById(jobForm.getCoreCompetencyId());

        Job newJob = new Job(aName, aEmployer, aLocation, aPositionType, aCoreCompentency);
